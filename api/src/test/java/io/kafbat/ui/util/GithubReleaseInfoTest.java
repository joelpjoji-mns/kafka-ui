...
class GithubReleaseInfoTest {
  ...
  void test() {
        ...
        .setBody("""
            {
              ...
              "tag_name": "v0.6.0",
              "html_url": "https://github.com/joelpjoji-mns/Mykafka-Ui/releases/tag/v0.6.0",
              "some_unused_prop": "ololo"
            }
            """));
    var url = mockWebServer.url("repos/joelpjoji-mns/Mykafka-Ui/releases/latest").toString();
    ...
    assertThat(i.html_url())
        .isEqualTo("https://github.com/joelpjoji-mns/Mykafka-Ui/releases/tag/v0.6.0");
